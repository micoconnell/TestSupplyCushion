...
interchangeDFBCIM = interties_ScrapeForecast(settings.current_DateAESOFORMAT(),settings.current_DateAESOFORMAT(),1,1)
interchangeDFBCIM= interchangeDFBCIM.reset_index()
interchangeDFBCEX = interties_ScrapeForecast(settings.current_DateAESOFORMAT(),settings.current_DateAESOFORMAT(),1,2)
interchangeDFBCEX = interchangeDFBCEX.reset_index()
interchangeDFMATLIM = interties_ScrapeForecast(settings.current_DateAESOFORMAT(),settings.current_DateAESOFORMAT(),1,3)
interchangeDFMATLIM= interchangeDFMATLIM.reset_index()
interchangeDFMATLEX = interties_ScrapeForecast(settings.current_DateAESOFORMAT(),settings.current_DateAESOFORMAT(),1,4)
interchangeDFMATLEX= interchangeDFMATLEX.reset_index()
interchangeDFSKIM = interties_ScrapeForecast(settings.current_DateAESOFORMAT(),settings.current_DateAESOFORMAT(),1,5)
interchangeDFSKIM = interchangeDFSKIM.reset_index()
interchangeDFSKEX = interties_ScrapeForecast(settings.current_DateAESOFORMAT(),settings.current_DateAESOFORMAT(),1,6)
