...
class NRGStreamApiDCRActiveSpinning:
...
try:    
    ...
    reedus = settings.futureDCRActiveSpinning
    #reedus = int(reedus)
    #f.close()
    nrgStreamApi = NRGStreamApiDCRActiveSpinning(settings.USERNAME,settings.PASSWORD)         
